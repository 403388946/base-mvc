...
<head>
    ...
    <link href="${ctx}/assets/css/plugins/select2/css/select2.min.css" rel="stylesheet">
...
<script type="text/javascript" src="${ctx}/assets/js/plugins/select2/js/select2.min.js" ></script>
<script type="text/javascript" src="${ctx}/assets/js/plugins/select2/js/i18n/zh-CN.js" ></script>
